...
async fn enricher_updates_hosts_in_cache() {
    ...
    enrichers.insert(
        ...
        Enricher {
            ...
            target_id: "src-test".to_string(),
            script_path: Some("tests/adapters/out/enrichers/enricher.py".to_string()),
            script_args: vec![],
            project_id: None,
            source_id: None,
            fields: None,
...
async fn enricher_without_cached_source_returns_404() {
    ...
    enrichers.insert(
        ...
        Enricher {
            ...
            target_id: "src-nonexistent".to_string(),
            script_path: Some("tests/adapters/out/enrichers/enricher.py".to_string()),
            script_args: vec![],
            project_id: None,
            source_id: None,
